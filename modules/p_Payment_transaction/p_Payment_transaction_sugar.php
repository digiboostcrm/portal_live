 ...
 * PLACE ANY CUSTOMIZATIONS IN p_Payment_transaction
 */

require_once('include/SugarObjects/templates/company/Company.php');

class p_Payment_transaction_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'p_Payment_transaction';
	var $object_name = 'p_Payment_transaction';
	var $table_name = 'p_payment_transaction';
	...
	var $SecurityGroups;
	var $p_payment_transaction_type;
	var $industry;
	var $annual_revenue;
	var $phone_fax;

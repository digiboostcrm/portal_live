    ...
    array (
      ...
      array (
        ...
        array(
          ...
          'AOP_CREATE' => 
          array (
            'customCode' => '{if !empty($fields.username_c.value)}<input type="submit" class="button" onClick="this.form.action.value=\'createPortalUser\';" value="{$MOD.LBL_CREATE_PORTAL_USER}"> {/if}',
            'sugar_html' => 
            array (
              'type' => 'submit',

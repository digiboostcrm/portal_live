...
if(!class_exists('MultiuploadOFLicense')) 
{
    class MultiuploadOFLicense
    {
        /**
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false)
        {
            ...
            $validated = MultiuploadOFLicense::doValidate($thisModule);
        ...
        public static function validate()
        {
            ...
            $validated = MultiuploadOFLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null)
        {
            ...
            {
                $GLOBALS['log']->fatal('MultiuploadOFLicense::doValidate() failed: '.print_r($response,true));
            }
        ...
        public static function change()
        {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('MultiuploadOFLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add()
        {
            ...
            $response = MultiuploadOFLicense::doValidate($currentModule);

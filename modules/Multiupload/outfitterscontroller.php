...
require_once('modules/'.$currentModule.'/license/MultiuploadOFLicense.php');

if($_REQUEST['method'] == 'validate') {
    MultiuploadOFLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    MultiuploadOFLicense::change();
} else if($_REQUEST['method'] == 'add') {
    MultiuploadOFLicense::add();
    ...
    $validate_license = MultiuploadOFLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = MultiuploadOFLicense::doValidate($currentModule);

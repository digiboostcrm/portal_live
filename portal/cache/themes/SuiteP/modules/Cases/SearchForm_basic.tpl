...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='case_number_basic'> {sugar_translate label='LBL_NUMBER' module='Cases'}</label>
					</div>
...
{/if}  
<input type='text' name='{$fields.case_number_basic.name}' 
    id='{$fields.case_number_basic.name}' size='30' 
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='subject_basic' >{sugar_translate label='LBL_SUBJECT' module='Cases'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{html_options id='subject_basic' name='subject_basic[]' options=$fields.subject_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.subject_basic.value}
		</div>
		<div class="search-clear"></div>
	</div>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='category_basic' >{sugar_translate label='LBL_CATEGORY' module='Cases'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{html_options id='category_basic' name='category_basic[]' options=$fields.category_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.category_basic.value}
		</div>
		<div class="search-clear"></div>
	</div>

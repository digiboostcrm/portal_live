...
{capture name="label" assign="label"}{sugar_translate label='LBL_MARKETING_PROJECT' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.marketing_project_domain.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.marketing_project_domain.value) <= 0}
{assign var="value" value=$fields.marketing_project_domain.default_value }
{else}
{assign var="value" value=$fields.marketing_project_domain.value }
{/if} 
<span class="sugar_field" id="{$fields.marketing_project_domain.name}">{$fields.marketing_project_domain.value}</span>
{/if}

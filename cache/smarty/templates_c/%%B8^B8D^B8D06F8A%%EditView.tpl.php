...
<div class="col-xs-12 col-sm-2 label" data-label="LBL_MARKETING_PROJECT">
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="varchar" field="marketing_project_domain" colspan='3' >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['marketing_project_domain']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['marketing_project_domain']['name']; ?>
' size='30' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
</div>
...
<?php echo '\' );
addToValidate(\'EditView\', \'marketing_project_domain\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MARKETING_PROJECT','module' => 'Accounts','for_js' => true), $this);?>
<?php echo '\' );

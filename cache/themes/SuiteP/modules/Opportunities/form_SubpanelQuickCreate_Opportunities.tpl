...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'lead_type', 'enum', false,'{/literal}{sugar_translate label='LBL_LEAD_TYPE' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_USER_OPP_OWNER_USER_ID' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'user_opp_owner_c', 'relate', false,'{/literal}{sugar_translate label='LBL_USER_OPP_OWNER' module='Opportunities' for_js=true}{literal}' );

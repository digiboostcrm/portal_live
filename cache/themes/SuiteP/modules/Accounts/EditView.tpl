...
{/if}  
<input type='text' name='{$fields.marketing_project_domain.name}' 
id='{$fields.marketing_project_domain.name}' size='30' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'marketing_project_domain', 'varchar', false,'{/literal}{sugar_translate label='LBL_MARKETING_PROJECT' module='Accounts' for_js=true}{literal}' );

...
$hook_array['before_save'][] = Array(78, 'Calculate logic', 'custom/modules/Opportunities/OpportunitiesCalculate.php','OpportunitiesCalculate', 'calculateLogic'); 
$hook_array['before_save'][] = Array(79, 'Create Account', 'custom/modules/Opportunities/OpportunitiesCalculate.php','OpportunitiesCalculate', 'accountCreate'); 

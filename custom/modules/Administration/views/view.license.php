...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
           ...
           translate('LBL_PORTAL_CONF_LINK','Administration').': '.translate('LBL_PORTAL_CONF_LINK_DESC','Administration'),
           );
    }
    ...
    public function display()
    {
        ...
        $url_instance = (!empty($administration->settings['PortalPlugin_PortalInstance'])) ? $administration->settings['PortalPlugin_PortalInstance'] : "";
        $url = (!empty($administration->settings['PortalPlugin_PortalInstance_url'])) ? $administration->settings['PortalPlugin_PortalInstance_url'] : "";
        $LastValidation=$administration->settings['PortalPlugin_LastValidation'];
        $UrlArry = array("WPUrl" => "WordPress", "DPUrl" => "Drupal", "JMUrl" => "Joomla");
        $this->ss->assign("LastValidationCheck",$LastValidation);
        $this->ss->assign("url_instance",$url_instance);
        $this->ss->assign("url",$url);
        $this->ss->assign("UrlArry",$UrlArry);
    ...
    protected static function loadLicenseStrings()
    {
        ...
        foreach ( $langs as $lang ) {
            ...
            if(!@include("custom/modules/".$currentModule."/license/language/$lang.lang.php")) {

...
class actionSendEmailMultiupload extends actionBase {
    ...
    function actionSendEmailMultiupload($id = ''){
    ...
    function edit_display($line,SugarBean $bean = null, $params = array()){
		...
		$html .= '<td id="name_label" scope="row" valign="top" width="12.5%">'.translate("LBL_MULTIUPLOAD_FIELD","AOW_Actions").':<span class="required">*</span></td>';
        $html .= "<td valign='top' width='37.5%'>";
    ...
    function sendEmail($emailTo, $emailSubject, $emailBody, $altemailBody, SugarBean $relatedBean = null, $emailCc = array(), $emailBcc = array(), $attachments)
    {

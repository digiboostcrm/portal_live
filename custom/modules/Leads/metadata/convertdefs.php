...
$viewdefs['Opportunities']['ConvertLead'] = array(
    ...
    'templateMeta' => array(
        'form'=>array(
            'hidden'=>array(
			0 => '<input type="hidden" name="Opportunitiesonline_date_c" id="Opportunitiesonline_date_c" value=" ">',
			1 => '<input type="hidden" name="Opportunitiesprobability" id="Opportunitiesprobability" value=" ">',
            )
        ),
        'maxColumns' => '2', 
        'widths' => array(

...
$hook_array['after_ui_footer'][] = Array(15, 'custom action button for right signature', 'modules/UT_RightSignature/logic_hooks/display_action_button.php','UT_RS_DisplayActionButton', 'UT_RS_DisplayActionButtonProcess'); 

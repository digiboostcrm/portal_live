...
class SugarWebServiceImplv4 extends SugarWebServiceImplv3_1 {
    ...
    * @exception 'SoapFault' -- The SOAP error, if any
    */
    function get_entry_list($session, $module_name, $query, $order_by,$offset, $select_fields, $link_name_to_fields_array = array(), $max_results = 0, $deleted = false, $favorites = false ){

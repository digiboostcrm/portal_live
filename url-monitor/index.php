...
if(isset($_GET["action"]) && ($_GET["action"] === "portalAccessToken" || $_GET["action"] === "portalResetPassword" || $_GET["action"] === "portalLogin") && $router->getService('user')->isUserLoggedIn()) {
    $router->getService('user')->doLogout();
    if($_GET["action"] === "portalLogin"){
